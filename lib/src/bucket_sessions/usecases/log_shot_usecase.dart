...
class LogShotUsecase {
  LogShotUsecase(this._repository);

  final IBucketSessionsRepository _repository;

  Future<Either<BucketSessionsFailure, BucketSession>> call({
    required String sessionId,
    required ShotLog shot,
  }) => _repository.logShot(sessionId, shot);
}
